...
<div class="row header-description-row">
    ...
    <div class="header-hero-media header-hero-media-v-align col-md col-xs-12 <?php echo esc_attr(apply_filters( 'mesmerize_slide_media_vertical_align-'.$slide['slide_id'], $slide['slide_media_box_settings_media_vertical_align'] )); ?>">
